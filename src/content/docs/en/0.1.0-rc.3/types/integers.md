...
Use the [individual primitive pages](./primitives/int8/) for focused examples and ranges.

The [Numeric conversions](./numeric-conversions/) leaf lists every conversion family and its failure rules.
