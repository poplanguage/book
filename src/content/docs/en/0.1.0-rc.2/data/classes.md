...
Classes in this release are nominal: their declared identity matters even when another class happens to contain the same fields. General source-level inheritance is not part of the supported 0.1.0-rc.2 feature set. Use interfaces to describe shared behavior.
