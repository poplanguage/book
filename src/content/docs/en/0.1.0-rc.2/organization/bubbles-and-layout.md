...
In 0.1.0-rc.2, manifest execution builds library and binary Bubbles and requires exactly one binary to run. Discovery of the other roles exists, but a complete test/benchmark command workflow is not exposed by the driver.
