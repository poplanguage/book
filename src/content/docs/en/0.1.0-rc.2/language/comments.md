...
Documentation generation is not yet exposed as a finished command in 0.1.0-rc.2, but the syntax and compiler validation are implemented. Writing useful documentation now keeps public declarations ready for future tooling.
