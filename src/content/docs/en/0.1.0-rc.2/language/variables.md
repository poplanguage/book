...
Function parameters behave much like initialized locals: their type is declared in the function signature, their value is supplied by the caller, and they can be assigned another value of the same type.
