---
title: Installation
description: Download and verify Pop 0.1.0-rc.2 on Linux.
sidebar:
  order: 2
---

The easiest way to install Pop is to download the ready-to-use archive from the [Pop releases page](https://github.com/poplanguage/pop/releases/tag/v0.1.0-rc.2). You do not need Rust, Cargo, LLVM, or the Pop source repository to follow this book.

Pop 0.1.0-rc.2 provides Linux archives for two processor architectures:
