...
The manifest format also recognizes a `[dependencies]` table, but dependency resolution is not available in 0.1.0-rc.2. For now, use a Bubble to organize code that belongs to one project; do not expect it to download external packages.
